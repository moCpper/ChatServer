...
template<> ::message::LoginResp* Arena::CreateMaybeMessage<::message::LoginResp>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace message {
...
class LoginReq PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kTokkenFieldNumber = 2,
    kUidFieldNumber = 1,
  };
  // string tokken = 2;
  void clear_tokken();
  const std::string& tokken() const;
  void set_tokken(const std::string& value);
  void set_tokken(std::string&& value);
  void set_tokken(const char* value);
  void set_tokken(const char* value, size_t size);
  std::string* mutable_tokken();
  std::string* release_tokken();
  void set_allocated_tokken(std::string* tokken);
  private:
  const std::string& _internal_tokken() const;
  void _internal_set_tokken(const std::string& value);
  std::string* _internal_mutable_tokken();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr tokken_;
  ::PROTOBUF_NAMESPACE_ID::int32 uid_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_message_2eproto;
};
...
class LoginResp PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:message.LoginResp) */ {
 public:
...
// string tokken = 2;
inline void LoginReq::clear_tokken() {
  tokken_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& LoginReq::tokken() const {
  // @@protoc_insertion_point(field_get:message.LoginReq.tokken)
  return _internal_tokken();
}
inline void LoginReq::set_tokken(const std::string& value) {
  _internal_set_tokken(value);
  // @@protoc_insertion_point(field_set:message.LoginReq.tokken)
}
inline std::string* LoginReq::mutable_tokken() {
  // @@protoc_insertion_point(field_mutable:message.LoginReq.tokken)
  return _internal_mutable_tokken();
}
inline const std::string& LoginReq::_internal_tokken() const {
  return tokken_.Get();
}
inline void LoginReq::_internal_set_tokken(const std::string& value) {
  
  tokken_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void LoginReq::set_tokken(std::string&& value) {
  
  tokken_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:message.LoginReq.tokken)
}
inline void LoginReq::set_tokken(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  tokken_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:message.LoginReq.tokken)
}
inline void LoginReq::set_tokken(const char* value,
    size_t size) {
  
  tokken_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:message.LoginReq.tokken)
}
inline std::string* LoginReq::_internal_mutable_tokken() {
  
  return tokken_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* LoginReq::release_tokken() {
  // @@protoc_insertion_point(field_release:message.LoginReq.tokken)
  return tokken_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void LoginReq::set_allocated_tokken(std::string* tokken) {
  if (tokken != nullptr) {
    
  } else {
    
  }
  tokken_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), tokken,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:message.LoginReq.tokken)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 LoginResp::_internal_error() const {
  return error_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LoginResp::error() const {
  // @@protoc_insertion_point(field_get:message.LoginResp.error)
  return _internal_error();
}
inline void LoginResp::_internal_set_error(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  error_ = value;
}
inline void LoginResp::set_error(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_error(value);
...
inline ::PROTOBUF_NAMESPACE_ID::int32 LoginResp::_internal_uid() const {
  return uid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 LoginResp::uid() const {
  // @@protoc_insertion_point(field_get:message.LoginResp.uid)
  return _internal_uid();
}
inline void LoginResp::_internal_set_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  uid_ = value;
}
inline void LoginResp::set_uid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_uid(value);
...
inline void LoginResp::set_token(const std::string& value) {
  _internal_set_token(value);
...
inline void LoginResp::set_token(std::string&& value) {
  
  token_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:message.LoginResp.token)
}
inline void LoginResp::set_token(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  token_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:message.LoginResp.token)
}
inline void LoginResp::set_token(const char* value,
    size_t size) {
  ...
  token_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:message.LoginResp.token)
}
