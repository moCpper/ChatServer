...
void StatusService::Stub::experimental_async::Login(::grpc::ClientContext* context, const ::message::LoginReq* request, ::message::LoginResp* response, std::function<void(::grpc::Status)> f) {
...
void StatusService::Stub::experimental_async::Login(::grpc::ClientContext* context, const ::message::LoginReq* request, ::message::LoginResp* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
